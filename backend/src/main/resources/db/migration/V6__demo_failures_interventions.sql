-- V6: Demo failures and interventions for dashboard, search and RAG testing
...
VALUES
    ('f1111111-1111-1111-1111-111111111111', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa',
     ...
     'RESOLUE', 'Moteur convoyeur A en surchauffe, arrêt automatique', 'F001'),
    ('f2222222-2222-2222-2222-222222222222', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb',
     ...
     'RESOLUE', 'Variateur ABB affiche défaut surintensité ligne 2', 'E001'),
    ('f3333333-3333-3333-3333-333333333333', 'cccccccc-cccc-cccc-cccc-cccccccccccc',
     ...
     'CLOTUREE', 'Capteur niveau silo 3 signal erroné, risque débordement', 'S004'),
    ('f4444444-4444-4444-4444-444444444444', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa',
     ...
     'EN_COURS', 'Vibrations anormales moteur convoyeur A', 'F002'),
    ('f5555555-5555-5555-5555-555555555555', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb',
     ...
     'OUVERTE', 'Communication Modbus intermittente variateur ligne 2', 'E012');
