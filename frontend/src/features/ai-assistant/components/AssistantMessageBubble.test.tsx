...
import { PremiumAssistantMessageBubble } from './PremiumMessageBubble';

import type { AssistantMessage } from '../types';



describe('PremiumAssistantMessageBubble', () => {
  ...
  it('renders summary, causes, actions and disclaimer', () => {
    ...
    render(<PremiumAssistantMessageBubble message={message} />);
